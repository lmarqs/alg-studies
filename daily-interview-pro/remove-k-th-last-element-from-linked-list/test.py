...
class Test(unittest.TestCase):
    ...
    def test_remove_kth_from_linked_list(self):
        ...
        self.assertEqual(
            [2, 3, 4, 5], remove_kth_from_linked_list(buildLinkedList(), 5).toList()
        )

        self.assertEqual(
            [1, 2, 4, 5], remove_kth_from_linked_list(buildLinkedList(), 3).toList()
        )

        self.assertEqual(
            [1, 2, 3, 4], remove_kth_from_linked_list(buildLinkedList(), 1).toList()
        )
