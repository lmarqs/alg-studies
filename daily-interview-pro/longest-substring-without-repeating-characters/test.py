...
class Test(unittest.TestCase):
    ...
    def test_lengthOfLongestSubstring_withOneRepeatingCharsAtTheBeginingOfTheString(self):
        self.assertEqual(3, Solution().lengthOfLongestSubstring('aabc'))

    def test_lengthOfLongestSubstring_withTwoRepeatingCharsAtTheBeginingOfTheString(self):
        self.assertEqual(3, Solution().lengthOfLongestSubstring('aabc'))
